...
CUSTOM_PACKAGES="$CUSTOM_PACKAGES geoview xray-core sing-box hysteria shadowsocksr-libev-ssr-local shadowsocksr-libev-ssr-redir luci-app-passwall luci-i18n-passwall-zh-cn"
